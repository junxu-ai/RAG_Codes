## sample code from langgraph for agent exection with SQL database https://python.langchain.com/docs/tutorials/sql_qa/
## added the agent execution with SQL database
## added the human in the loop (HITL) feature before execting the query
