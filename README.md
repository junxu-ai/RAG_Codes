...
The code repository for the book "Retrieval-Augmented Generation in Production: Architecture, Patterns, and Runbooks" by Jun Xu, to be published by World Scientific Press in earlier 2026. 
