...
The code repository is for the book "Retrieval-Augmented Generation in Production: Architecture, Patterns, and Runbooks" by Jun Xu, which will be published by World Scientific Press in earlier 2026. 
